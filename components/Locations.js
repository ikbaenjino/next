const locations = [
  { city: "Jakarta", branches: ["Kelapa Gading", "PIK", "Menteng"] },
  { city: "Tangerang", branches: ["BSD", "Alam Sutera"] },
  { city: "Bandung", branches: ["Cihampelas", "Dago"] },
  { city: "Surabaya", branches: ["Citraland", "Dharmahusada"] },
];
