...
export default function HomePage() {
  return (
    <section className="bg-lightBg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col-reverse lg:flex-row items-center gap-12 py-16">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <button className="btn-primary">GRATIS! Kelas Pertama</button>
        </div>
